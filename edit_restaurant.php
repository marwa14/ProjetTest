                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id</label>
                                    <br>
                                    <label id="id"><?php echo $rest->ID; ?> </label>
                                </div>
                                <div class="form-group">
                                    <label>Nom <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="nom"  value="<?php echo $rest->NOM; ?>"/>
                                </div>
                                <div class="form-group">
                                <label>Description <span>(Required Field)</span></label>
                                <textarea class="form-control autogrow"   id="description"> <?php echo $rest->DESCRIPTION; ?> </textarea>
                                </div>
                                <div class="form-group" >
                                    <label>Region <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="region" value="<?php echo $rest->REGION; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>Localisation<span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="localisation" value="<?php echo $rest->LOCALISATION; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>Horaire d'ouverture <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="horaire" value="<?php echo $rest->HORAIRE_OUVERTURE; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>moyen de paiement <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="moyen" value="<?php echo $rest->MOYEN_PAIEMENT; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>service <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="service" value="<?php echo $rest->SERVICE; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>nombre de table <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="nb_table" value="<?php echo $rest->NB_TABLE; ?>"/>
                                </div>
                                <div class="form-group" >
                                    <label>nombre de personne par table <span>(Required Field)</span></label>
                                    <input type="text" class="form-control"  id="nb_pers_table" value="<?php echo $rest->NB_PERS_TABLE; ?>"/>
                                </div>
                                <?php if ($rest->FEATURED==1)
