    ...
    $(document).ready(function()
    {
        $.fn.myFunctionDelete = function(ID){
            ...
            $.confirm({
                ...
                confirm: function(){
                    $.post("<?php echo site_url('/gallerie_evenement/delete'); ?>",
                        {
                            ID: ID
                        });
                    window.location.href = "<?php echo site_url('gallerie_evenement'); ?>";
    ...
    $(document).ready(function()
    {
        $("#submit").click(function()
        {
            ...
            if ((id=="") || (userfile=="")) {
                ...
                $.post("<?php echo site_url('/gallerie_restaurant/create'); ?>",
                    {
                        id: id, userfile: userfile
                    },
                    function(data){
                ...
                window.location.href = "<?php echo site_url('gallerie_restaurant'); ?>";
                            ...
                            <div class="box col-md-12">
                                <div class="box-inner">
                                    ...
                                    <div class="box-content">
                                        ...
                                        <?php if ($eve==null) echo "vous n'avez pas d'évènement  !!!!!" ;
                                        else {
                                            echo form_open_multipart('/gallerie_evenement/create',array('method'=>'POST')); ?>
                                            <div class='form-group'>
                                            <label for='exampleInputFile'>Titre</label> <br>
                                            <?php echo form_input('titre'); ?>
                                            </div>
                                           <label>Evenement <span>(Required Field)</span></label>
                                            <br>
                                            <?php
                                            $option=array();
                                            foreach($eve as $row)
                                            {
                                                $option[$row->ID_EVE]=$row->NOM;
                                            }
                                           echo form_dropdown('nom',$option); ?>
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <ul class="thumbnails gallery">
                                ...
                                <?php  if (isset($image)) :foreach ($image as $row) : ?>
                                    <li  class="thumbnail">
                                        <a style="background:url(../uploads/evenement/<?php echo $id."/".$row->IMAGE; ?>)"
                                           title="<?php echo $row->IMAGE?>" href="../uploads/evenement/<?php echo $id."/".$row->IMAGE ;?>">
                                            <img
                                                class="grayscale" src="../uploads/evenement/<?php echo $id."/".$row->IMAGE ; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" >
                            ...
                            <?php if (isset($image)) : foreach ($image as $row) : ?>
                                <tr>
                                    <td class="center"><?php echo $row->ID_IM; ?></td>
                                    <td class="center"><?php echo $row->ID_EVE; ?></td>
                                    <td class="center"><?php echo $row->IMAGE; ?></td>
                                    <td class="center"><?php echo $row->TITRE; ?></td>
                                    <td >
                                        <input type="button" class="btn btn-danger"  value="Delete" onclick="$.fn.myFunctionDelete(<?php echo $row->ID_IM ?>)";/>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
