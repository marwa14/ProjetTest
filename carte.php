...
<script>
    $(document).ready(function()
    {
        ...
        $.fn.myFunctionDelete = function(ID){
            $.confirm({
                title: 'Confirm!',
                content: 'Voulez vous vraiment supprimer cette carte!!',
                confirm: function(){
                    $.post("<?php echo site_url('/carte/delete'); ?>",     //"./client/create"
                        {
                            ID: ID
                        });
                    window.location.href = "<?php echo site_url('carte'); ?>";
                },
                cancel: function(){
                    $.alert('Canceled!')
                }
    ...
    $(document).ready(function()
    {
        $("#submit").click(function()
        {
            ...
            if ((nom==""))  {
                ...
                $.post("<?php echo site_url('/carte/create'); ?>",   //"./client/create"
                    {
                        nom: nom, 
                    }
                );
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <tbody>
                                <?php  if (isset($carte)) :foreach ($carte as $row) : ?>
                                    <tr>
                                        <td class="center"><?php echo $row->ID_CARTE; ?></td>
                                        <td class="center"><?php echo $row->NOM; ?></td>
                                        <td >
                                            <?php echo anchor("/carte/edit_page/$row->ID_CARTE",'Edit','class="btn btn-info "'); ?> <input type="button" class="btn btn-danger " value="Delete" onclick="$.fn.myFunctionDelete(<?php echo $row->ID_CARTE ?>)"; />
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                                </tbody>
