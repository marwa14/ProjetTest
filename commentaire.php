        ...
        <div id="content" class="col-lg-10 col-sm-10">
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-user"></i> Commentaire</h2>
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                    ...
                    <tbody>
                    <?php  if (isset($comm)) :foreach ($comm as $row) : ?>
                        <tr>
                            <td class="center"><?php echo $row->NOM; ?></td>
                            <td class="center"><?php echo $row->PRENOM; ?></td>
                            <td class="center"><?php echo $row->COMMENTAIRE; ?></td>
