...
<script>
    $(document).ready(function()
    {
        $("#edit").click(function()
        {
            var nom=$("#nom").val();
            var ID=$("#id_carte").val();
            var id_repas=$("#id").text();
            var description = $("#description").val();
            var categorie = $("#categorie").val();
            var prix = $("#prix").val();
            if ((nom == "") || (ID == "") || (description == "") || (prix == "") ) {
                ...
                $.post("<?php echo site_url('/repas/edit'); ?>",   //"./client/create"
                    {
                        nom: nom, ID: ID, categorie: categorie, id_repas:id_repas , description : description , prix: prix
                    }
                );
...
<script>
    $(document).ready(function()
    {
        $("select[name='carte']").change( function()
        {
            $("#categorie").empty();
                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id_repas</label>
                                    <br>
                                    <label id="id"><?php echo $repas->ID_REPAS; ?> </label>
                                </div>
                                <div class="form-group">
                                    <label>carte <span>(Required Field)</span></label>
                                    <select class="form-control" name="carte" id="id_carte">
                                        <?php
                                        foreach($carte as $row)
                                        {
                                            if ($carte->ID_CARTE = $repas->ID_CARTE)
                                                echo "<option value='".$row->ID_CARTE."'  selected> $row->NOM </option>";

                                            else echo "<option value='".$row->ID_CARTE."' > $row->NOM</option>";
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="nom"  value="<?php echo $repas->NOM; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Description <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="description"  value="<?php echo $repas->DESCRIPTION; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Prix <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="prix"  value="<?php echo $repas->PRIX; ?>"/>
                                </div>
                                <div class="form-group">
