    ...
    $(document).ready(function()
    {
        $("#edit").click(function()
        {
            ...
            if ((date_fin== "") || (date_deb== "")||(pourc== "") || (id_repas== null))  {
                ...
                $.post("<?php echo site_url('/promotion/edit'); ?>",  
                    {
                        date_fin: date_fin, date_deb: date_deb, pourc: pourc, id_repas: id_repas, ID:ID
                    }
                );
                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id</label>
                                    <br>
                                    <label id="id"><?php echo $promo->ID_PRO; ?> </label>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control"  id="id_repas">
                                        ...
                                        {
                                            if ($repas->ID_REPAS = $promo->ID_REPAS)
                                                echo "<option value='".$row->ID_REPAS."'  selected> $row->NOM </option>";

                                            else echo "<option value='".$row->ID_REPAS."' > $row->NOM</option>";
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pourc"  value="<?php echo $promo->POURCENTAGE; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Date début<span>(Required Field)</span></label>
                                    <input type="date" class="form-control" id="date_deb"  value="<?php echo $promo->DATE_DEBUT; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Date fin<span>(Required Field)</span></label>
                                    <input type="date" class="form-control" id="date_fin"  value="<?php echo $promo->DATE_FIN; ?>"/>
                                </div>
                                <br>
                                <br>
