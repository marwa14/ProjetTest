...
<script>
    $(document).ready(function()
    {
        ...
        $.fn.myFunctionDelete = function(ID){
            ...
            $.confirm({
                title: 'Confirm!',
                content: 'Voulez vous vraiment supprimer ce repas!!',
                confirm: function(){
                    $.post("<?php echo site_url('/repas/delete'); ?>",     //"./client/create"
                        {
                            ID: ID
                        });
                    window.location.href = "<?php echo site_url('repas'); ?>";
                },
                cancel: function(){
                    $.alert('Canceled!')
                }
...
<script>
    $(document).ready(function()
    {
    $("select[name='carte']").click( function()
    {
        $("#categorie").empty();
        var carte_cat= $("select[name='carte'] > option:selected").val();

        $.post("<?php echo site_url('/categorie/get_categorie'); ?>",
            {
                carte_cat: carte_cat
            },
            function(data){
...
<script>
    $(document).ready(function()
    {
        $("#submit").click(function()
        {
            ...
            var prix = $("#prix").val();
            if ((nom=="") || (carte == null) || (description =="") || (prix ==""))  {
                ...
                if (isNaN(prix)){
                    ...
                    $( "#alert" ).addClass( "alert alert-danger" );
                    $("#alert")
                        .text("prix doit être un entier")

                }
                
              else {
                    $.post("<?php echo site_url('/repas/create'); ?>",   //"./client/create"
                        {
                            nom: nom, carte: carte, categorie: categorie, description: description, prix: prix
                        }
                    );
                    window.location.href = "<?php echo site_url('repas'); ?>";
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-user"></i> Datatable Repas</h2>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <tbody>
                                <?php  if (isset($repas)) :foreach ($repas as $row) : ?>
                                    <tr>
                                        <td class="center"><?php echo $row->ID_REPAS; ?></td>
                                        <td class="center"><?php echo $row->ID_CARTE; ?></td>
                                        <td class="center"><?php echo $row->NOM; ?></td>
                                        <td class="center"><?php echo $row->DESCRIPTION; ?></td>
                                        <td class="center"><?php echo $row->PRIX; ?></td>
                                        <td class="center"><?php echo $row->CATEGORIE; ?></td>
                                        <td >
                                            <?php echo anchor("/repas/edit_page/$row->ID_REPAS",'Edit','class="btn btn-info "'); ?>   <input type="button" class="btn btn-danger"  value="Delete" onclick="$.fn.myFunctionDelete(<?php echo $row->ID_REPAS ?>)";/>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                                </tbody>
                    ...
                    <div class="modal-content">
                        <div class="row">
                            <div class="box col-md-12">
                                <div class="box-inner">
                                    <div class="box-header well" data-original-title="">
                                        <h2><i class="glyphicon glyphicon-edit"></i> Add repas</h2>
                                    </div>
                                    <div class="box-content">
                                        <div id="alert">
                                        </div>
                                        <form role="form">
                                            ...
                                            <select class="form-control" id="id_carte" name="carte">
                                                <?php
                                            ...
                                            <div class="form-group">
                                                <label>Prix <span>(Required Field)</span></label>
                                                <input type="text" class="form-control" id="prix" />
                                            </div>
                                            <label>Categorie <span>(Required Field)</span></label>
