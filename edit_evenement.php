...
<script>
    $(document).ready(function()
    {
        $("#edit").click(function()
        {
            ...
            if ((nom=="")||(description=="")||(date=="")||(horaire=="")) {
                ...
                $.post("<?php echo site_url('/evenement/edit'); ?>",   //"./client/create"
                    {
                        nom: nom, id_eve:id_eve, description:description, date:date ,horaire:horaire
                    }
                );
                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id</label>
                                    <br>
                                    <label id="id"><?php echo $eve->ID_EVE; ?> </label>
                                </div>
                                <div class="form-group">
                                    <label>Nom <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="nom"  value="<?php echo $eve->NOM; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Description <span>(Required Field)</span></label>
                                    <textarea  class="form-control autogrow" id="description" > <?php echo $eve->DESCRIPTION; ?></textarea>
                                </div>
                                <div class="form-group">
                                    <label>Date <span>(Required Field)</span></label>
                                    <input type="date" class="form-control" id="date"  value="<?php echo $eve->DATE_EV; ?>"/>
                                </div>
                                <div class="form-group">
                                    <label>Horaire <span>(Required Field)</span></label>
                                    <input type="time" class="form-control" id="horaire"  value="<?php echo $eve->HORAIRE; ?>"/>
                                </div>
                                <br>
                                <br>
