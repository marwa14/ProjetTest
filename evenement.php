    ...
    $(document).ready(function()
    {
        ...
        $.fn.myFunctionDelete = function(ID){
            ...
            $.confirm({
                ...
                confirm: function(){
                    $.post("<?php echo site_url('/evenement/delete'); ?>",     
                        {
                            ID: ID
                        });
                    window.location.href = "<?php echo site_url('evenement'); ?>";
                },
                cancel: function(){
                    $.alert('Canceled!')
                }
...
<script>
    $(document).ready(function()
    {
        $("#submit").click(function()
        {
            ...
            if ((nom=="") || (date == "") || (description =="") || (horaire ==""))  {
                ...
                $("#alert")
                    ...
                    $.post("<?php echo site_url('/evenement/create'); ?>",   //"./client/create"
                        {
                            nom: nom, horaire: horaire, date: date, description: description
                        }
                    );
                    window.location.href = "<?php echo site_url('evenement'); ?>";
                ...
                <div class="box col-md-12">
                    <div class="box-inner">
                        <div class="box-header well" data-original-title="">
                            <h2><i class="glyphicon glyphicon-user"></i> Datatable Evénement</h2>
                        ...
                        <div class="box-content">
                            <table class="table table-striped table-bordered bootstrap-datatable datatable responsive">
                                ...
                                <tbody>
                                <?php  if (isset($eve)) :foreach ($eve as $row) : ?>
                                    <tr>
                                        <td class="center"><?php echo $row->ID_EVE; ?></td>
                                        <td class="center"><?php echo $row->NOM; ?></td>
                                        <td class="center"><?php echo $row->DESCRIPTION; ?></td>
                                        <td class="center"><?php echo $row->DATE_EV; ?></td>
                                        <td class="center"><?php echo $row->HORAIRE; ?></td>
                                        <td >
                                            <?php echo anchor("/evenement/edit_page/$row->ID_EVE",'Edit','class="btn btn-info "'); ?>   <input type="button" class="btn btn-danger"  value="Delete" onclick="$.fn.myFunctionDelete(<?php echo $row->ID_EVE ?>)";/>
                                        </td>
                                    </tr>
                                <?php endforeach ?>
                                </tbody>
                    ...
                    <div class="modal-content">
                        <div class="row">
                            <div class="box col-md-12">
                                <div class="box-inner">
                                    <div class="box-header well" data-original-title="">
                                        <h2><i class="glyphicon glyphicon-edit"></i> Add évènement</h2>
                                    </div>
                                    <div class="box-content">
                                        <div id="alert">
                                        </div>
                                        <?php if ($rest==null) echo "vous n'avez pas de restaurant  !!!!!" ;
                                            ...
                                            <t type="text" class="form-control" id="description"/>
                                            </div>
                                                <div class="form-group">
                                            ...
                                            <div class="form - group">
                                            <label>Horaire <span>(Required Field)</span></label>
                                                <br>
                                            <input type="time" class="form-control" id="horaire"/>
                                            </div>
                                            <br>
                                            <br>
