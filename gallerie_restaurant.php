    ...
    $(document).ready(function()
    {
        $.fn.myFunctionDelete = function(ID){
                ...
                $.confirm({
                    ...
                    confirm: function(){
                        $.post("<?php echo site_url('/gallerie_restaurant/delete'); ?>",
                            {
                                ID: ID
                            });
                        ...
                        <div class="box col-md-12">
                            <div class="box-inner">
                                ...
                                <div class="box-content">
                                    ...
                                    echo form_open_multipart('/gallerie_restaurant/create',array('method'=>'POST'));
                                   echo "<div class='form-group'>";
                                         echo   "<label for='exampleInputFile'>Titre</label> <br>";
                                    echo form_input('titre');
                                            echo "</div>";
                                  echo  "<div class='form-groupe'>";
                                           echo"<label for='exampleInputFile'>Image</label>";
                                          echo  "<input type='file' id='userfile' name='userfile'>";
                                       echo  "</div>";
                                    echo "<br>";
                                    echo "<br>";
                    ...
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                            ...
                            <ul class="thumbnails gallery">
                                ...
                                <li  class="thumbnail">
                                    <a style="background:url(../uploads/restaurant/<?php echo $id."/".$row->IMAGE; ?>)"
                                       title="<?php echo $row->IMAGE?>" href="../uploads/restaurant/<?php echo $id."/".$row->IMAGE ;?>">
                                        <img
                                            class="grayscale" src="../uploads/restaurant/<?php echo $id."/".$row->IMAGE ; ?>"
                        ...
                        <table class="table table-striped table-bordered bootstrap-datatable datatable responsive" >
                            ...
                            <?php if (isset($image)) : foreach ($image as $row) : ?>
                                <tr>
                                    <td class="center"><?php echo $row->ID_IMG; ?></td>
                                    <td class="center"><?php echo $row->ID; ?></td>
                                    <td class="center"><?php echo $row->IMAGE; ?></td>
                                    <td class="center"><?php echo $row->TITRE; ?></td>
                                    <td >
                                        <input type="button" class="btn btn-danger"  value="Delete" onclick="$.fn.myFunctionDelete(<?php echo $row->ID_IMG ?>)";/>
                                    </td>
                                </tr>
                            <?php endforeach ?>
                            </tbody>
