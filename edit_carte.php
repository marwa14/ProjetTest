    ...
    $(document).ready(function()
    {
        $("#edit").click(function()
        {
            ...
            if ((nom=="")) {
                ...
                $.post("<?php echo site_url('/carte/edit'); ?>",   //"./client/create"
                    {
                        nom: nom, id_carte:id_carte
                    }
                );
                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id</label>
                                    <br>
                                    <label id="id"><?php echo $carte->ID_CARTE; ?> </label>
                                </div>
                                <div class="form-group">
                                    <label>Nom <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="nom"  value="<?php echo $carte->NOM; ?>"/>
                                </div>
                                <br>
                                <br>
