    ...
    $(document).ready(function()
    {
        $("#edit").click(function()
        {
            ...
            if ((nom == "")) {
                ...
                $.post("<?php echo site_url('/categorie/edit'); ?>",   
                    {
                        nom: nom, id_carte: id_carte, id:id
                    }
                );
            ...
            <div class="sidebar-nav">
                <div class="nav-canvas">
                    ...
                    <ul class="nav nav-pills nav-stacked main-menu">
                        ...
                        <li><a class="ajax-link" href="http://localhost/CodeIgniter-3.0.6/index.php/categorie"  ><i class="glyphicon glyphicon-start"></i><span> Catégorie</span></a>
                        </li>
                        ...
                        <div class="box-content">
                            ...
                            <form role="form">
                                <div class="form-group">
                                    <label>Id</label>
                                    <br>
                                    <label id="id"><?php echo $categorie->ID; ?> </label>
                                </div>
                                <div class="form-group">
                                    <label>Nom <span>(Required Field)</span></label>
                                    <input type="text" class="form-control" id="nom"  value="<?php echo $categorie->NOM; ?>"/>
                                </div>
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_carte">
                                        ...
                                        {
                                            if ($carte->ID_CARTE == $categorie->ID_CARTE)
                                                echo "<option value='".$row->ID_CARTE."' id='id_carte' selected> $row->NOM </option>";

                                            else echo "<option value='".$row->ID_CARTE."' id='id_carte'> $row->NOM</option>";
